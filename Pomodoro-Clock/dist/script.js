...
class TimerLengthControl extends React.Component {
  render() {
    return (
      React.createElement("div", { className: "TimerLengthControl" },
      React.createElement("div", { className: "subtitle", id: this.props.titleID },
      this.props.title),

      React.createElement("div", { className: "timer-controls" },
      React.createElement("button", { id: this.props.minID, value: "-", onClick: this.props.onClick },
      React.createElement("i", { className: "fas fa-arrow-down" })),

      React.createElement("div", { id: this.props.lengthID }, this.props.length),
      React.createElement("button", { id: this.props.addID, value: "+", onClick: this.props.onClick },
...
class App extends React.Component {
  ...
  render() {
    return (
      ...
      React.createElement("div", { style: this.state.alarmColor },
